  ...
  def create
    ...
    respond_to do |format|
      if @email_address.save
        format.html { redirect_to person_path(@email_address.person), notice: 'Email address was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @email_address.update(email_address_params)
        format.html { redirect_to person_path(@email_address.person), notice: 'Email address was successfully updated.' }
