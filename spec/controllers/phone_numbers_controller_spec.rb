...
RSpec.describe PhoneNumbersController, type: :controller do
  ...
  let(:person){ Person.create(first_name: 'John', last_name: 'Meyer') }

  let(:valid_attributes) {
    {number: '9999999999', person_id: person.id}
  }
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "redirects to the phone_number's person" do
        valid_attributes = {number: '+19999999999', person_id: person.id}
        post :create, {:phone_number => valid_attributes}, valid_session
  ...
  describe "PUT #update" do
    context "with valid params" do
      let(:new_person){
        Person.create(first_name: 'Ron', last_name: 'Doe')
      }

      let(:new_attributes) {
        {number: '888888888', person_id: new_person.id}
      }
      ...
      it "updates the requested phone_number" do
        ...
        phone_number.reload
        expect(phone_number.number).to eq('888888888')
        expect(phone_number.person_id).to eq(new_person.id)
      end
