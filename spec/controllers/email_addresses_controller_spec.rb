...
RSpec.describe EmailAddressesController, type: :controller do
  ...
  let(:valid_attributes) {
    {address: 'johndoe@example.com', person_id: person.id}
  }
  ...
  describe "PUT #update" do
    context "with valid params" do
      let(:new_attributes) {
        {address: 'johndoe_new@example.com', person_id: person.id}
      }
      ...
      it "updates the requested email_address" do
        ...
        expect(email_address.address).to eq('johndoe_new@example.com')
